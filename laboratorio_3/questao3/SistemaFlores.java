...
public class SistemaFlores {
    public static void main(String[] args) {
        // Criando o catálogo
        CatalogoDeFlores catalogo = new CatalogoDeFlores();
        
        // Adicionando flores nacionais
        catalogo.adicionarFlor(new Rosa());
        catalogo.adicionarFlor(new Margarida());
        
        // Adicionando flor importada usando o Adapter
        ImportedFlower tulipa = new Tulip("Holanda");
        FloresNacionais tulipaAdapter = new TulipAdapter(tulipa);
        catalogo.adicionarFlor(tulipaAdapter);
        
        // Demonstrando o cálculo diferenciado de preço para flores importadas
        System.out.println("\n== Comparação de Preços ==");
        System.out.println("Preço original da tulipa: R$ " + String.format("%.2f", tulipa.getPrice()));
        System.out.println("Preço após taxas de importação: R$ " + String.format("%.2f", tulipaAdapter.obterPreco()));
    }
}