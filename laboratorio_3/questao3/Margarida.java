...
// Classes concretas de flores nacionais que implementam a interface
class Margarida implements FloresNacionais {
    @Override
    public void exibirDescricao() {
        System.out.println("Margarida: Flor delicada e comum em jardins brasileiros.");
    }
    ...
    public String obterCor() {
        return "Branca com centro amarelo";
    }
}