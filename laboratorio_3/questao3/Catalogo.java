...
// Cliente que utiliza o sistema de flores
class CatalogoDeFlores {
    public void adicionarFlor(FloresNacionais flor) {
        System.out.println("\n== Detalhes da Flor ==");
        flor.exibirDescricao();
        System.out.println("Cor: " + flor.obterCor());
        System.out.println("Preço: R$ " + String.format("%.2f", flor.obterPreco()));
    }
}